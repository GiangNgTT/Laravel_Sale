  ...
  <div class="container">
    ...
    <div class="pull-right">
      <div class="beta-breadcrumb font-large">
        <a href="/banhang/index">Home</a> / <span>Details</span>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="single-item-options">
              ...
              <a class="add-to-cart" href="{{route('banhang.addtocart',$sanpham->id)}}"><i
            ...
            <div class="col-sm-4">
              <div class="single-item">
                ...
                <div class="single-item-caption">
                  <a class="add-to-cart pull-left" href="{{route('banhang.addtocart',$sp->id)}}"><i
                      class="fa fa-shopping-cart"></i></a>
